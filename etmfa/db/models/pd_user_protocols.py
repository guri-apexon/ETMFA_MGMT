...
class PDUserProtocols(db_context.Model):
    ...
    id = db_context.Column(db_context.Integer(),
    ...
    userRole = db_context.Column(db_context.String(
        200), default=config.UPLOADED_USERROLE)
    redactProfile = db_context.Column(db_context.String(
        50), default=config.USERROLE_REDACTPROFILE_MAP.get(config.UPLOADED_USERROLE))
