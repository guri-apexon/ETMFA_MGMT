...
class Protocoldata(db_context.Model):
    ...
    iqvdataToc = db_context.Column(db_context.VARCHAR(None))
    iqvdataSoa = db_context.Column(db_context.VARCHAR(None))
    iqvdataSoaStd = db_context.Column(db_context.VARCHAR(None))
    iqvdataSummary = db_context.Column(db_context.VARCHAR(None))
