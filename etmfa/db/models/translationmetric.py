...
class TranslationMetric(db_context.Model):
	__tablename__ = "tms_translation_metrics"
	...
	metric = db_context.relationship(Metric, backref='translation_metrics', lazy=False)
	...
	def __repr__(self):
		return '<Translation Metric. Translation Metrics ID: {}>'.format(self.id)
