...
class Documentfeedback(db_context.Model):
    __tablename__ = "pd_document_feedback"
    ...
    doc_file_path = db_context.Column(db_context.String(500))
    feedback_source = db_context.Column(db_context.String(300))
    ...
    document_date = db_context.Column(db_context.String(300))
    doc_classification = db_context.Column(db_context.String(300))
    ...
    attribute_aux_list = db_context.Column(db_context.String(2000))
