...
class Documentattributes(db_context.Model):
    ...
    doc_class                             = db_context.Column(db_context.String(300))
    ...
    tmf_environment                       = db_context.Column(db_context.String(300))
    tmf_ibr                               = db_context.Column(db_context.String(300))
    ...
    doc_date_type                         = db_context.Column(db_context.String(500))
    ...
    alcoac_check_comp_score               = db_context.Column(db_context.String(500))
    alcoac_check_comp_score_conf          = db_context.Column(db_context.String(30))
    alcoac_check_error                    = db_context.Column(db_context.String(1000))
