...
def test_normalized_soa(new_app_context, aidoc_id, source_system, operation_value, footnotes, expected_status_cd, comments):
    new_app, _ = new_app_context
    client = new_app.test_client()
    input_dict = {"operationValue": operation_value , "id": aidoc_id, "sourceSystem": source_system, "footnotes": footnotes}
...
@pytest.mark.parametrize("update_request, expected_status_cd, comments",
                         [
                            ...
                            ({ "operation": "update", "sub_type": "add_study_procedure", "table_props": { "doc_id": "d4153421-2b47-4ec5-b21c-80d907d73227", "table_roi_id": "5c2c26d4-6583-4c61-a3cb-473f38b86384", "table_row_index": "0", "table_column_index": "0", "timepoint": "", "value": "Study Test" } }, HTTPStatus.OK, "Normal"),
                            ({ "operation": "update", "sub_type": "add_study_visit", "table_props": { "doc_id": "d4153421-2b47-4ec5-b21c-80d907d73227", "table_roi_id": "bb900b05-034c-4430-ad27-34a6039561b2", "table_column_index": "18", "study_visit": [{ "table_row_index": "0", "timepoint": "cycle_timepoint", "value": "SH1" }] } }, HTTPStatus.OK, "Normal"),
                          ])
