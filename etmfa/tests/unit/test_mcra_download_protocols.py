...
@pytest.mark.parametrize(
    "protocol_number, id, approval_date, version_number, document_status, source_system, response_status, comments",
    [("test1", "9274fc1f-e645-4411-9b46-67d409e70108", "20140508", "1.0", "final", "unit_test", HTTPStatus.OK,
     ...
     ("", "9274fc1f-e645-4411-9b46-67d409e70108", "20140508", "1.0", "final", "unit_test", HTTPStatus.NOT_FOUND,
      "Missing protocol"),
     ("test1", "", "20140508", "1.0", "final", "unit_test", HTTPStatus.OK, "Normal"),
...
def test_mcra_download_protocol(new_app_context, protocol_number, id, approval_date, version_number,
                                document_status, source_system, response_status, comments):
    new_app, _ = new_app_context
    client = new_app.test_client()
    input_dict = {"protocolNumber": protocol_number, "id": id, "approvalDate": approval_date,
                  "versionNumber": version_number,
                  "documentStatus": document_status, "sourceSystem": source_system}
    with client:
        logger.debug(
            f"test_mcra_download_protocol: Processing for unit test type [{comments}]: [{protocol_number}, {id}, {version_number}]")
