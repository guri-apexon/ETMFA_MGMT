...
@pytest.mark.parametrize("op, aidoc_id, field_name, attribute_names, expected_status_cd, comments",
                         [(DELETE_FIELD, "", "summary_extended", [], HTTPStatus.OK, "delete summary_extended if there only for consistency"),
                          (DELETE_FIELD, DOC_ID, "test_info.aa.bb.cc.dd.ee", [], HTTPStatus.OK, "delete field if there only for consistency"),
                          (DELETE_FIELD, DOC_ID, "test_info.aa.bb.cc.dd.ee", [],  HTTPStatus.OK, "at level 6"),
                          (DELETE_FIELD, DOC_ID, "test_info.aa.bb.cc.dd", [],  HTTPStatus.OK, "at level 5"),
                          (DELETE_FIELD, DOC_ID, "test_info.aa.bb.cc", [],  HTTPStatus.OK, "at level 4"),
                          (DELETE_FIELD, DOC_ID, "test_info.aa.bb", [],  HTTPStatus.OK, "at level 3"),
                          (DELETE_FIELD, DOC_ID, "test_info.aa", [],  HTTPStatus.OK, "at level 2"),
                          (DELETE_FIELD, DOC_ID, "test_info", [], HTTPStatus.OK, "at level 1"),
                        ])
...
@pytest.mark.parametrize("op, aidoc_id, field_name, attributes, expected_status_cd, comments,valid",
                         [ (ADD_FIELD, DOC_ID, "test_info", [],  HTTPStatus.OK, "at level 1", True),
                             ...
                             (ADD_FIELD, DOC_ID, "test_info.aa.bb.cc.dd.ee.ff", [],  HTTPStatus.NOT_FOUND, "Not allow more than 6 level", False),
                             (ADD_FIELD, "", "summary_extended.l1.l2.l3.l4.l5", [], HTTPStatus.OK, "summary_extended fields added", True),
                             (ADD_FIELD, "", "summary_extended.l1.l2.l3.l4.l5.l6", [], HTTPStatus.NOT_FOUND, "Not allow more than 6 level", False),
                             (ADD_ATTRIBUTES, "", "summary_extended", [{"attr_name": "Team", "attr_type": "string", "attr_value": "accordionTeam", "note": "", "confidence": ""}],  HTTPStatus.OK, "added in summary_extended", True)
                         ])
...
@pytest.mark.order(4)
@pytest.mark.parametrize("op, aidoc_id, field_name, attributes, expected_status_cd, comments, valid",
                         [(ADD_FIELD, DOC_ID, "test_info.aa.bb.cc.dd.ee", [],  HTTPStatus.OK, "Normal",True),
                          (ADD_ATTRIBUTES, DOC_ID, "test_info.aa.bb.cc.dd.ee", [{"attr_name": "testFor", "attr_type": "string", "attr_value": "sugar"},
                          ...
                          (ADD_FIELD, "", "summary_extended", [], HTTPStatus.OK, "Normal", True)
                          ])
...
@pytest.mark.parametrize("op, aidoc_id, field_name, attribute_names, expected_status_cd, comments, valid",
                         [("", DOC_ID, "test_info.aa.bb.cc.dd.ee", ["num_houses"],  HTTPStatus.NOT_FOUND, "Missing op", False),
                          (DELETE_ATTRIBUTE, DOC_ID, "test_info.aa.bb.cc.dd.ee", ["no_of_years", "isHealthy","treatment_timeperiod", "treatment", "testFor", "treatment_week_timeperiod"],  HTTPStatus.OK, "Normal", True),
                          (DELETE_FIELD, "", "test_info.aa.bb.cc.dd.ee", [],  HTTPStatus.OK, "Normal", True),
                          (DELETE_FIELD, DOC_ID, "test_info", [],  HTTPStatus.OK, "at level 1", True),
                          (DELETE_FIELD, DOC_ID, "test_info.aa", [],  HTTPStatus.OK, "at level 2", True),
                          (DELETE_FIELD, DOC_ID, "test_info.aa.bb", [],  HTTPStatus.OK, "at level 3", True),
                          (DELETE_FIELD, DOC_ID, "test_info.aa.bb.cc", [],  HTTPStatus.OK, "at level 4", True),
                          (DELETE_FIELD, DOC_ID, "test_info.aa.bb.cc.dd", [],  HTTPStatus.OK, "at level 5", True),
                          (DELETE_FIELD, DOC_ID, "test_info.aa.bb.cc.dd.ee", [], HTTPStatus.OK, "at level 6", True),
                          (DELETE_ATTRIBUTE, "", "summary_extended", ["Sponsor", "testFor", "Team"], HTTPStatus.OK, "summary_extended fields deleted", True)
                          ])
...
@pytest.mark.parametrize("op, aidoc_id, field_name, attribute_names, expected_status_cd, comments, valid",
                         [
                          (DELETE_FIELD,"", "summary_extended", [], HTTPStatus.OK, "summary_extended fields deleted", True)
                           ]
                         )
