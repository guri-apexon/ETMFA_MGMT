...
@pytest.mark.parametrize("aidocid, protocol_number, document_path, insert_flag",
                        [
                            ('171ef754-2a33-4c8d-8a90-009941ddbba0', 'test_compare_0213_K-877-302', r'./etmfa/tests/data/171ef754-2a33-4c8d-8a90-009941ddbba0', 1),
                            ('171ef754-2a33-4c8d-8a90-009941ddbba0', '', r'./etmfa/tests/data/171ef754-2a33-4c8d-8a90-009941ddbba0', 0),
                            ('171ef754-2a33-4c8d-8a90-009941ddbba0', 'test_compare_0213_K-877-302', '', 0),
                        ])
        ...
        with _app_context:
            ...
            if ids_compare_protocol and insert_flag:
                for row in ids_compare_protocol:
                    dict_[(row['id1'], row['id2'])]['compare_id'] = row['compareId']
