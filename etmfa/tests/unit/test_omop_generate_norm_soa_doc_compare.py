...
#                          [("2182c51f-fcee-4c1c-8a4c-dd9636ad0f91", "omop_generate" , HTTPStatus.OK, "Normal"),
#                           ("", "omop_generate", HTTPStatus.NOT_FOUND, "Missing docId"),
#                           ("a81dca57-c2e1-42f2-8ecd-61787d8f9d01", "",  HTTPStatus.NOT_FOUND, "Missing workFlowName"),
#                           ("", "", HTTPStatus.NOT_FOUND, "All missing")
#                           ])
# def test_omop_generate(new_app_context, docId, workFlowName ,expected_status_cd, comments):
