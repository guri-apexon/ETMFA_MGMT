...
VM_AUTH_PD_UI_BACKEND=$VM_AUTH_PD_UI_BACKEND
VM_PD_UI_BACKEND_LINK=$VM_PD_UI_BACKEND_LINK
VM_UI_HOST_NAME=$VM_UI_HOST_NAME
VM_EMAILS_ENABLED=$VM_EMAILS_ENABLED
VM_FROM_EMAIL=$VM_FROM_EMAIL
VM_SMTP_HOST=$VM_SMTP_HOST
